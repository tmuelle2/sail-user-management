/**
 * The html form required to capture all user account info.
 */
<style>
...
<form accept-charset="UTF-8" action="<?php esc_url(admin_url('admin-post.php')) ?>" id="user_reg" autocomplete="on" method="post">

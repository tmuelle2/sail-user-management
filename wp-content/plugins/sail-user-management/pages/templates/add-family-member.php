<script type="text/javascript">
  makeFormRestSubmit('sail_user_add_family_member', <? use Sail\Constants; echo Constants::FORM_REST_PREFIX . 'add-family-member'; ?>); 
</script>
<details>
    ...
    <div>
        ...
        <form accept-charset="UTF-8" id="sail_user_add_family_member" autocomplete="on">
            <input type="hidden" name="action" value="sail_user_add_family_member">
        ...
        <button type="submit" form="sail_user_add_family_member" value="Submit">Submit</button>
        <br/>

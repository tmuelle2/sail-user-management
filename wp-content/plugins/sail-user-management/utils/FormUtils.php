...
final class FormUtils
{
    ...
    public const SITUATION_CHECKBOXES = array(
        '<div>' .
            '<input class="sitch"  type="checkbox" name="situation" id="situation1" value="Need to commit to understanding steps involved in developing a housing solution.">' .
            '<label for="situation1">Need to commit to understanding steps involved in developing a housing solution</label>' .
        '</div>',
        '<div>' .
            '<input class="sitch"  type="checkbox" name="situation" id="situation2" value="Need support to understand Government Benefits like SSI, SSDI, Medicaid, Bridge Card, etc.">' .
            '<label for="situation2">Need support to understand Government Benefits like SSI, SSDI, Medicaid, Bridge Card, etc</label>' .
        '</div>',
        '<div>' .
            '<input class="sitch" type="checkbox" name="situation" id="situation3" value="Need to connect with others to develop friendships/roommates">' .
            '<label for="situation3">Need to connect with others to develop friendships/roommates</label>' .
        '</div>',
        '<div>' .
            '<input class="sitch"  type="checkbox" name="situation" id="situation4" value="Interested in learning about different housing models">' .
            '<label for="situation4">Interested in learning about different housing models</label>' .
        '</div>',
        '<div>' .
            '<input class="sitch"  type="checkbox" name="situation" id="situation5" value="Interested in developing a support model and finding staff">' .
            '<label for="situation5">Interested in developing a support model and finding staff</label>' .
        '</div>',
        '<div>' .
            '<input class="sitch"  type="checkbox" name="situation" id="situation6" value="Need information on how to prepare for moving into a new place">' .
            '<label for="situation6">Need information on how to prepare for moving into a new place</label>' .
        '</div>',
        '<div>' .
            '<input class="sitch"  type="checkbox" name="situation" id="situation7" value="Need information and resources that can help in the transition to a new place">' .
            '<label for="situation7">Need information and resources that can help in the transition to a new place</label>' .
        '</div>',
        '<div>' .
            '<input class="sitch"  type="checkbox" name="situation" id="situation8" value="Interested in supporting and maintaining an existing housing solution">' .

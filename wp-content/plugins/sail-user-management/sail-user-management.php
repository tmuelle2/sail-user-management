...
$sail_home_dir = '/home2/sailhou1/public_html/wp-content/plugins/sail-user-management/';
...
function sail_plugin_init() {
    global $wp_rewrite;
    add_rewrite_rule();
    add_rewrite_rule('register[/]$', $sail_home_dir . '/forms/registration.php', 'top');
...
function sail_user_register() {
    global $sail_home_dir;
    include_once($sail_home_dir . 'user-registration.php');
}

function sail_user_signon() {
    //global $sail_home_dir;
    include_once($sail_home_dir . 'user-signon.php');
}
